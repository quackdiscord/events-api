...
async function messageDeleteEvent(data: any) {
...
async function messageUpdateEvent(data: any) {
...
async function messageBulkDeleteEvent(data: any) {
    const eventType = "message_bulk_delete";

    const messages = data.messages,
        authors = messages.map((message: any) => {
...
// export the events
export { messageDeleteEvent, messageUpdateEvent, messageBulkDeleteEvent };
