...
// server update event
async function serverUpdateEvent(data: any) {
    const eventType = "server_update";

    const event = data.event,
        oldServer = data.oldServer,
    ...
    const send = await sendMessage(
        ...
        settings.types.server.webhook_url
    ).catch((error) => {
...
async function channelCreateEvent(data: any) {
...
async function channelDeleteEvent(data: any) {
...
async function channelPinsUpdateEvent(data: any) {
...
async function channelUpdateEvent(data: any) {
...
// emoji create event
async function emojiCreateEvent(data: any) {
...
// emoji delete event
async function emojiDeleteEvent(data: any) {
...
// emoji update event
async function emojiUpdateEvent(data: any) {
    const eventType = "emoji_update";

    const event = data.event,
        oldEmoji = data.oldEmoji,
        newEmoji = data.newEmoji,
        guild = data.guild;
...
// event create event
async function eventCreateEvent(data: any) {
...
// event delete event
async function eventDeleteEvent(data: any) {
...
// event update event
async function eventUpdateEvent(data: any) {
    // later
}

// invite create event
async function inviteCreateEvent(data: any) {
...
// invite delete event
async function inviteDeleteEvent(data: any) {
...
// role create event
async function roleCreateEvent(data: any) {
...
// role delete event
async function roleDeleteEvent(data: any) {
...
// role update event
async function roleUpdateEvent(data: any) {
    const eventType = "role_update";

    const event = data.event,
        oldRole = data.oldRole,
        newRole = data.newRole,
        newPerms = data.newPerms,
        oldPerms = data.oldPerms,
        guild = data.guild;
...
async function stickerCreateEvent(data: any) {
    // TODO
}

// sticker delete event
async function stickerDeleteEvent(data: any) {
    // TODO
}

// sticker update event
async function stickerUpdateEvent(data: any) {
    // TODO
}

// thread create event
async function threadCreateEvent(data: any) {
    // TODO
}

// thread delete event
async function threadDeleteEvent(data: any) {
    // TODO
}

// thread update event
async function threadUpdateEvent(data: any) {
    // TODO
}
